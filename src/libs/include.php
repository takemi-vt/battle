...
require_once __DIR__.'\Magics\MagicAttribute.php';
require_once __DIR__.'\Magics\MagicType.php';
require_once __DIR__.'\Magics\Magic.php';
require_once __DIR__.'\Magics\MagicList.php';